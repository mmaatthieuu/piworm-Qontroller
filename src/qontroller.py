...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.label_64)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.spinIlluminationPulse)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.checkBoxOptogen)
        self.label_25 = QtWidgets.QLabel(self.scrollAreaWidgetContents_9)
        self.label_25.setObjectName("label_25")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.label_25)
        self.comboOptoColor = QtWidgets.QComboBox(self.scrollAreaWidgetContents_9)
        self.comboOptoColor.setObjectName("comboOptoColor")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.comboOptoColor)
        ...
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.FieldRole, self.checkBoxLog)
        ...
        self.btnEditHostList = QtWidgets.QPushButton(self.scrollAreaWidgetContents_9)
        self.btnEditHostList.setObjectName("btnEditHostList")
        self.gridLayout_3.addWidget(self.btnEditHostList, 0, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btnRescanDevices, 0, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btnCheckUpdates, 1, 0, 1, 1)
        self.btnUpdateAll = QtWidgets.QPushButton(self.scrollAreaWidgetContents_9)
        self.btnUpdateAll.setObjectName("btnUpdateAll")
        self.gridLayout_3.addWidget(self.btnUpdateAll, 1, 1, 1, 1)
        self.verticalLayout_2.addLayout(self.gridLayout_3)
        self.btnSelfCheck = QtWidgets.QPushButton(self.scrollAreaWidgetContents_9)
        self.btnSelfCheck.setObjectName("btnSelfCheck")
        self.verticalLayout_2.addWidget(self.btnSelfCheck)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnEditHostList.setText(_translate("MainWindow", "Edit Hosts List"))
        ...
        self.btnSelfCheck.setText(_translate("MainWindow", "Run Self-Check"))
